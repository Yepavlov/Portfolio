...
#Copy the content of the current directory (.) on the host machine to the '/app' directory inside the Docker image
COPY . /app
...
#Upgrade pip (Python package installer) to the latest version
